...
import HockyGrounds from './pages/HockeyGrounds'; // Import new component
import GolfGrounds from './pages/GolfGrounds'; // Import new component
import TennisGrounds from './pages/TennisGrounds'; // Import new component
    ...
    <ThemeProvider theme={theme}>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/select-hockey-ground" element={<HockyGrounds/>}/>
          <Route path="/select-golf-ground" element={<GolfGrounds />} /> {/* New route */}
          <Route path="/select-tennis-ground" element={<TennisGrounds />} /> {/* New route */}
