...
import TennisImage from '../assets/tens.jpg';
...
const ImageContainer = styled('div')({
  ...
  borderRadius: '8px',
  backgroundImage: `url(${TennisImage})`, // Set the background image here
});
        ...
        <Grid item xs={12} md={6}>
          <BookPaper>
            ...
            <Typography paragraph>
              Our tennis court is top-quality and available for booking with flexible time slots. Enjoy excellent lighting for night games.
            </Typography>
